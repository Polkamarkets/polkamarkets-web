...
import styles from './QuestionCardOutcomes.module.scss';

type QuestionCardOutcomesProps = {
  market: Market;
  readonly?: boolean;
  compact?: boolean;
};

export default function QuestionCardOutcomes({
  market,
  readonly = false,
  compact = false
}: QuestionCardOutcomesProps) {
  // Hooks
  ...
  return (
    <div className={styles.root}>
      ...
      {needExpandOutcomes && !expandableOutcomes.isExpanded && (
        <OutcomeCard {...expandableOutcomesData} />
      )}
    </div>
  );
}
